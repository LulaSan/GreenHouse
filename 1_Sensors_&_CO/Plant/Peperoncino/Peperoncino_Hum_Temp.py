...
if __name__=="__main__":
    ...
    S_db=Sensor_plant(id,"/p4iot/plants/{}/sensors_pepper".format(id),"13.59.136.106", 1883)
    S_tb = TB_Sensor_plant(id,'svOmnwGu4RlAydXbdMHf','demo.thingsboard.io','v1/devices/me/telemetry',1883,60)
    print("Subscriber connected to: /p4iot/plants/{}/sensors_pepper".format(id))
