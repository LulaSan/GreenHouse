...
SIGNIN, SIGNIN_PULSANTI, ADMIN , ADMIN_TYPING, ADMIN_TYPING_2, LEVEL1, FARMER , FARMER_TYPING, FARMER_TYPING_2 ,FARMER_TYPING_3, USER, USER_TYPING= range(12)
...
def main():
    ...
    conf=json.load(open('utils.json','r'))
    token=conf['TOKEN']
    #token="1461734973:AAGtnon-G24cJcWVjVGbp7Lv1DIXhjJNT28" #Official
    #token="1990658567:AAG5By57hC8Hbyp9Mc2FTqqsIw8VLV_MsDM" # UnOfficial
