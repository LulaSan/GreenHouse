...
def buyitemuser(update: Update, context: CallbackContext) -> int:
  ...
  item=text[1]
  quantita=text[2]
  requests.delete(f"{SERVER}/buyitem/{farmerID}/{item}/{quantita}")
...
def Green_House_Parameters(update: Update, context: CallbackContext) -> int:
  THRESHOLD_HUMID_MIN=requests.get(url=f"{SERVER}/greenhouses/{greenhouse_id}/THRESHOLD_HUMID_MIN")
  THRESHOLD_HUMID_MAX=requests.get(url=f"{SERVER}/greenhouses/{greenhouse_id}/THRESHOLD_HUMID_MAX")
  THRESHOLD_BRIGHT_MIN=requests.get(url=f"{SERVER}/greenhouses/{greenhouse_id}/THRESHOLD_BRIGHT_MIN")
  THRESHOLD_BRIGHT_MAX=requests.get(url=f"{SERVER}/greenhouses/{greenhouse_id}/THRESHOLD_BRIGHT_MAX")
  THRESHOLD_TEMPER_MIN=requests.get(url=f"{SERVER}/greenhouses/{greenhouse_id}/THRESHOLD_TEMPER_MIN")
  THRESHOLD_TEMPER_MAX=requests.get(url=f"{SERVER}/greenhouses/{greenhouse_id}/THRESHOLD_TEMPER_MAX")
