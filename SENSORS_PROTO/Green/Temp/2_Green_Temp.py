...
if __name__=="__main__":
    ...
    lam = 24
    val = 57+0.3*np.random.poisson(lam, time_alive) 
    ...
    # S_cat=Sensor_t(id+'temp',"/p4iot/greenhouses/{}temperature".format(id),conf['broker'], conf['port'])
    S_tb = TB_Sensor_t(id,'JMIPtCmt2I5nW8PIzLHF','demo.thingsboard.io','v1/devices/me/telemetry',1883,60)
