...
class Linker:
    def __init__(self,clientID,messageBroker,messageBrokerPort):
        ...
        #THRESHOLD_BRIGHT
        self.brigth_min = greenHouseInfo[["GREENHOUSE_ID"]==self.clientID]['THRESHOLD_HUMID_MIN']
        self.brigth_max = greenHouseInfo[["GREENHOUSE_ID"]==self.clientID]['THRESHOLD_HUMID_MAX']
        
        self.status = greenHouseInfo[["GREENHOUSE_ID"]==self.clientID]["STATUS_CONTROLL_HUMIDITY"]
...
if __name__ == '__main__':
    ...
    while True:
        for num in range(num_of_greenHouses):
            ...
            print(green_ID)
            connect= Subscriber_get_info_h("controller_brgth",'/p4iot/greenhouses/'+green_ID+'/sensors/brigthness', '13.59.136.106', 1883)
